...
<x-app-layout>
    ...
    <div class="max-w-screen flex p-3 custom-bg">
        <div class="bg-white border border-2 shadow-lg rounded-lg mr-2 w-1/4 min-w-72 border">
            ...
            <div class="py-4 px-6 overflow-y-auto ticket-content" style="max-height: 70vh">
                <div class="mb-4">                    
                    ...
                    <p class="text-gray-400">{{ $ticket->created_at->format('M d, Y g:i A') }}</p>
                    @if ($ticket->assigned_to)
                        <span class="text-gray-400">Assigned to {{$ticket->ticket->name}}</span>
                    @endif
                </div>
                ...
                <div class="mb-6">
                    ...
                    @php
                        $contentLength = Str::length($ticket->content);
