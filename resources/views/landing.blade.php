...
<body class="font-sans" style="font-family:">
    <header class="text-gray-200 py-4 px-6 fixed bg-gray-800 w-full z-50 select-none">
    ...
    <section id="top" class="bg-blue-900 text-white py-32 pt-24 select-none" style="background-image: url('/images/psuscschool.jpg'); background-size: cover; position: relative; background-repeat: no-repeat; height:105vh">
        <video src=""></video>
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: #1f2937cb;">
            <div class="container mx-auto items-center">
                <div class="align-center justify-center flex" style="text-align: center">
                    <div style="max-width: 60%">
                        ...
                        <h1 class="text-4xl md:text-6xl font-bold mb-4 animate-right">Elevate Communication at<br>Pangasinan State University</h1>
                        ...
                        <a href="psusc.ai" class="bg-yellow-500 hover:bg-yellow-600 text-white py-4 px-6 font-bold rounded-full mr-3 transition-all duration-300 ease-in-out transform hover:scale-105">Explore Features</a>    
                        ...
                        @if (Route::has('login'))
                            ...
                            @else
                                <a href="{{ url('/login') }}" class="border border-white hover:bg-white text-white hover:text-gray-900 font-bold py-4 px-6 rounded-full ml-3 transition-all duration-300 ease-in-out transform hover:scale-105"><ion-icon class="mr-5" style="margin-left: -7px" name="arrow-forward-circle-outline"></ion-icon>Get Started</a> 
                            @endauth
                        @endif
                    </div>
                </div>
    ...
    <section>
        <div class="bg-gray-800 py-16">
            <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 select-none">
                <div class="container mx-auto">
                    <h2 class="text-3xl font-bold mb-6 text-center text-white">Trusted by Our Users</h2>
                    <!-- Updated the section heading to be more formal and compelling -->
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-gray-200 hover:bg-white p-6 rounded-lg transition-all duration-200 ease-in-out transform testM">
                            <!-- Added transition and transform classes for hover scale effect -->
                            ...
                            <div class="flex items-center">
                                <div class="relative w-10 h-10 mr-3">
                                    <img src="images/image.png" alt="Avatar" class="absolute inset-0 w-full h-full object-cover rounded-full pointer-events-none" />
                                </div>
                        ...
                        <div class="bg-gray-200 hover:bg-white p-6 rounded-lg transition-all duration-200 ease-in-out transform testM">
                            ...
                            <div class="flex items-center">
                                <div class="relative w-10 h-10 mr-3">
                                    <img src="images/juliet.png" alt="Avatar" class="absolute inset-0 w-full h-full object-cover rounded-full pointer-events-none" />
                                </div>
                                <!-- Replaced the placeholder avatar with a real image -->
                                <div>
                        ...
                        <div class="bg-gray-200 hover:bg-white p-6 rounded-lg transition-all duration-200 ease-in-out transform testM">
                            ...
                            <div class="flex items-center">
                                <div class="relative w-10 h-10 mr-3">
                                    <img src="images/drbuted.jpg" alt="Avatar" class="absolute inset-0 w-full h-full object-cover rounded-full pointer-events-none" />
                                </div>
                                <!-- Replaced the placeholder avatar with a real image -->
                                <div>
    ...
    <section class="container mx-auto p-10 hidden">
        <div>
            <h2 class="text-3xl font-bold mb-6 text-center">Contact Us</h2>
            <form action="#" method="POST" class="max-w-xl mx-auto">
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-bold mb-2">Name</label>
                    <input type="text" id="name" name="name" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500" required>
                </div>
                <div class="mb-4">
                    <label for="email" class="block text-gray-700 font-bold mb-2">Email</label>
                    <input type="email" id="email" name="email" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500" required>
                </div>
                <div class="mb-4">
                    <label for="message" class="block text-gray-700 font-bold mb-2">Message</label>
                    <textarea id="message" name="message" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500" rows="5" required></textarea>
                </div>
                <div class="text-center">
                    <button type="submit" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-full">Send Message</button>
                </div>
            </form>
            </div>
        </div>
    ...
    <section>
        <div class="bg-gray-800 py-16 flex mx-auto">
            <div class="px-4 sm:px-6 lg:px-8" style="flex:1">
                <div class="max-w-xl mx-auto">
                    <h2 class="text-3xl font-extrabold leading-9 text-white select-none">Contact Information</h2>
                    <p class="mt-2 text-lg leading-7 text-gray-400 select-none">Get in touch with us for more information or inquiries.</p>
                    <div class="mt-8 flex">
            ...
            <div style="flex:1">
                <form action="#" method="POST" class="max-w-xl mx-auto select-none">
                    <h2 class="text-3xl font-extrabold mb-6 text-white">Contact Us</h2>

                    <div class="mb-4">
                        <input type="text" id="name" name="name" placeholder="Name" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500 text-lg font-medium leading-6 text-gray-900" required>
                    </div>
                    <div class="mb-4">
                        <input type="email" id="email" name="email" placeholder="Email" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500 text-lg font-medium leading-6 text-gray-900" required>
                    </div>
                    <div class="mb-4">
                        <textarea id="message" name="message" placeholder="What are your thoughts?" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500 text-lg font-medium leading-6 text-gray-900" rows="5" required></textarea>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-full">Send Message</button>
                    </div>
    ...
    <footer class="bg-gray-800 text-white py-6 select-none">
        <div class="container mx-auto">
