            ...
            <div class="lg:w-2/3">
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="relative h-64 animate-gradient">
                        <img src="{{ asset(Auth::user()->profile_picture) }}" alt="Profile Picture" class="absolute bottom-0 left-8 transform translate-y-1/2 w-32 h-32 rounded-full border-4 border-white shadow-lg">
