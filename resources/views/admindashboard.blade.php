...
<x-app-layout>
    <x-slot name="header">
        <h2 class="flex font-semibold text-xl text-gray-800 leading-tight select-none">
            <img src="{{ asset('images/PSU logo.png') }}" class="w-6 h-6 mr-3" alt="">
            {{ __('Welcome, Admin ') }} 
            {{ Auth::user()->name }}
        ...
        <div class="max-w-screen p-4">
            <div class="sm:rounded-lg">
                <div class="text-gray-900">
                    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                        ...
                        <a href="tickets"  class="choices" style="">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div class="px-3 py-2 rounded-full bg-red-600 bg-opacity-75">
                        ...
                        <a href="manage-chatbot"  class="choices">
                            <div>
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div class="px-3 py-2 rounded-full bg-green-600 bg-opacity-75">
                        ...
                        <a href="UserManagement" class="choices">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="px-3 py-2 rounded-full bg-indigo-600 bg-opacity-75">
                    ...
                    <div class="grid grid-cols-5 gap-6 uppercase">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(revenueCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Revenue',
                        data: [12000, 19000, 15000, 25000, 18000, 19000],
