...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-200">
        <div class="max-h-screen">
            ...
            <!-- Page Heading -->
            @if (isset($header))
            <header id="header" class=" select-none shadow bg-white mainContents">
                <div id="header1" class="mx-auto py-3 px-6 flex items-center justify-between flex">
                    {{ $header }}
                    <div class="flex items-center side-header select-none">
                        <button class="bg-gray-800 text-white px-4 py-2 rounded-md text-sm font-medium">
            ...
            <!-- Page Content -->
            <main id="mainContent" class="mt-0 mainContents max-h-screen">
                {{ $slot }}
            </main>
        </div>
            ...
            <div id="profile_form">
                ...
                <div class="pb-6">
                    ...
                    <div class="flex border-t-2 flex-col">
                        ...
                        <a href="/notifications" class="flex items-center w-full py-2 px-4 bg--100 text-gray-900 text-center font-semibold hover:bg-blue-200 transition duration-300">
                            <i class="fas fa-bell text-xl mr-4 text-gray-400"></i>
                            Notifications
                        </a>
