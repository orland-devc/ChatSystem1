...
class TicketController extends Controller
{
    ...
    public function index()
    {
        ...
        $tickets = Ticket::with('user')->get()->sortByDesc('created_at');
        ...
        return view('tickets', compact('tickets', 'assignedTickets', 'closedTickets', 'unreadTickets', 'unreadTicketsCount', 'closedTicketsCount', 'assignedTicketsCount', 'allTickets'));


        // $users = User::where('role', 'Administrator')
        // ->where('name', 'like', '%Orland%')
        // ->get();
        // return view('admindashboard', compact('admindashboard'));
        ...
        if ($request->hasFile('attachments')) {
            foreach ($request->file('attachments') as $file) {
                ...
                Attachment::create([
                    ...
                    'ticket_id' => $ticket->id,
                    'file_name' => $imageName,
                    'file_location' => $uploadsDirectory . $imageName,
                ]);
            }
        }
    ...
    public function submitReply(Request $request, Ticket $ticket)
    {
        ...
        // If you prefer, you can return the newly created reply
